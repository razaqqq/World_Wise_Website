...
function CitiesProvider({
    ...
    useEffect(() => {
        async function fetchCities() {
            ...
            try {
                ...
                dispatch({ type: 'rejected', payload: 'There Was Error in Loading Data' })
            }
    ...
    const getCity = useCallback(async function getCity(id) {
        ...
        try {
            ...
            dispatch({
                type: 'rejected', payload: "There Was Error in Loading Data..."
            })
        }
    }, [currentCity.id])
    ...
    async function createCity(newCity) {
        ...
        try {
            ...
            dispatch({
                type: "rejected",
                payload: "There Was Error in Creating dnew City"
            })
        }
    ...
    async function deleteCity(id) {
        ...
        try {
            ...
            dispatch({ type: 'rejected', payload: "There Was Error in Deleting New City" })
        }
